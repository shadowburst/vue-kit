...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('settings/teams/billing/portal', [PortalController::class, 'show'])
        ->name('teams.billing.portal.show')
        ->middleware(RefuseDuringImpersonation::class);
    Route::post('settings/teams/billing/checkout', [CheckoutController::class, 'store'])
        ->name('teams.checkout.store')
        ->middleware(RefuseDuringImpersonation::class);
    Route::post('settings/teams/billing/cancel', [CancelController::class, 'store'])
        ->name('teams.billing.cancel.store')
        ->middleware(RefuseDuringImpersonation::class);
    Route::post('settings/teams/billing/resume', [ResumeController::class, 'store'])
        ->name('teams.billing.resume.store')
        ->middleware(RefuseDuringImpersonation::class);
});
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::put('settings/password', [SecurityController::class, 'update'])
        ...
        ->middleware(['throttle:6,1', RefuseDuringImpersonation::class]);
